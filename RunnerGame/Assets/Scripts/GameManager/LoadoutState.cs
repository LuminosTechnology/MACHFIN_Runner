...
public class LoadoutState : AState
{
    ...
    public override void Enter(AState from)
    {
        ...
        AudioClip _menuTheme = menuThemes[Random.Range(0, menuThemes.Length)]; 
        
        if (MusicPlayer.instance.GetStem(0) != _menuTheme)
        {
            MusicPlayer.instance.SetStem(0, _menuTheme);
    ...
    public override void Tick()
    {
        if (!runButton.interactable && _canRun)
        {
            ...
            if (interactable)
            {
                ...
                runButton.GetComponentInChildren<Text>().text = "Avançar";
